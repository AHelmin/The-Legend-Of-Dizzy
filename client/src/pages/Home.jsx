    ...
    <div>
      ...
      <div className="text-center mt-8 flex flex-col h-full">
        <img
          src={zeldadog}
          alt="Centered Image"
          className="mx-auto h-auto max-w-lg transition-all duration-300 rounded-lg filter grayscale hover:grayscale-0 homepage-image"
        />

        <div className="mt-4">
          <h1 className="text-4xl font-bold hyrule text-yellow-600">Welcome to The Legend of Dizzy</h1>
          <p className="text-lg mt-8 press-start text-white">
